...
const translations = {
  zh: {
    ...
    'tip.title': '开始前：',
    'tip.content': '在 Switch 上打开 DBI，选择 "Run MTP responder" 或 "Backend"，然后连接 USB 线缆。',
    'panel.files': '文件列表',
    'panel.log': '日志',
    'btn.addFolder': '添加文件夹',
    'btn.addFiles': '添加文件',
  ...
  en: {
    ...
    'tip.content': 'Open DBI on your Switch, select "Run MTP responder" or "Backend", then connect USB cable.',
    'panel.files': 'Files',
    'panel.log': 'Log',
